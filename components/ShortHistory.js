...
let list_item = data => data.map((e,i) => {
			return (
				<View key={`${e.toString()}${i}`} style={{ marginTop:'1%', marginBottom:'2%', flex: 1, alignItems: 'flex-end', justifyContent: 'space-between', flexDirection:'row' }}>
